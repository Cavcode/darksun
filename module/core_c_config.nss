...
const string INSTALLED_LIBRARIES = "pqj_l_plugin, dlg_l_plugin, demo_l_plugin, dmfi_l_dialogs";
...
const string INSTALLED_PLUGINS = "bw_defaultevents, dlg, pqj, dlg_dmfi";
