...
void RotateMe(object oTarget, int Amount, object oUser)
{
    ...
    if (GetObjectType(oTarget) != OBJECT_TYPE_PLACEABLE)
    {
        ...
        FloatingTextStringOnCreature("Target was not a placeable, used placeable closest to your avatar", oUser);
    }
    if (Amount == -2)
    {
...
void ReportImmunity(object oCreature, object oUser)
{
    string sMessage = 
        GetIsImmune(oCreature, IMMUNITY_TYPE_ABILITY_DECREASE) ? "\n  Ability Decrease" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_AC_DECREASE) ? "\n  AC Decrease" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_ATTACK_DECREASE) ? "\n  Attack Decrease" : "" +
        ...
        GetIsImmune(oCreature, IMMUNITY_TYPE_CRITICAL_HIT) ? "\n  Critical Hit" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_CURSED) ? "\n  Cursed" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_DAMAGE_DECREASE) ? "\n  Damage Decrease" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_DAMAGE_IMMUNITY_DECREASE) ? "\n  Damage Immunity Decrease" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_DAZED) ? "\n  Dazed" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_DEAFNESS) ? "\n  Deafness" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_DEATH) ? "\n  Death" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_DISEASE) ? "\n  Disease" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_DOMINATE) ? "\n  Domination" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_ENTANGLE) ? "\n  Entanglement" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_FEAR) ? "\n  Fear" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_KNOCKDOWN) ? "\n  Knockdown" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_MIND_SPELLS) ? "\n  Mind Spells" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_MOVEMENT_SPEED_DECREASE) ? "\n  Movement Speed Decrease" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_NEGATIVE_LEVEL) ? "\n  Negative Level" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_PARALYSIS) ? "\n  Paralysis" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_POISON) ? "\n  Poison" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_SAVING_THROW_DECREASE) ? "\n  Saving Throw Decrease" : "";
        GetIsImmune(oCreature, IMMUNITY_TYPE_SILENCE) ? "\n  Silence" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_SKILL_DECREASE) ? "\n  Skill Decrease" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_SLEEP) ? "\n  Sleep" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_SLOW) ? "\n  Slow" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_SNEAK_ATTACK) ? "\n  Sneak Attack" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_SPELL_RESISTANCE_DECREASE)? "\n  Spell Resistence Decrease" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_STUN) ? "\n  Stun" : "" +
        GetIsImmune(oCreature, IMMUNITY_TYPE_TRAP) ? "\n  Trap" : "";

    if (sMessage = "")
        sMessage = "None.";
    
    sMessage = "Immunites Found: " + sMessage;
}
...
void DoMusicFunction(int iMusic, object oUser)
{
    ...
    switch (iMusic)
    {
        ...
        case 12: 
            MusicBackgroundStop(GetArea(oUser)); 
            DelayCommand(1.0, MusicBackgroundStop(GetArea(oUser))); 
            return;
        ...
        case 31: iSet = TRACK_BATTLE_RURAL1;        break;
        case 32: iSet = TRACK_BATTLE_FOREST1;       break;
        case 33: iSet = TRACK_BATTLE_FOREST2;       break;
        case 34: iSet = TRACK_BATTLE_DUNGEON1;      break;
        case 35: iSet = TRACK_BATTLE_DUNGEON2;      break;
        case 36: iSet = TRACK_BATTLE_DUNGEON3;      break;
        case 37: iSet = TRACK_BATTLE_CITY1;         break;
        case 38: iSet = TRACK_BATTLE_CITY2;         break;
        case 39: iSet = TRACK_BATTLE_CITY3;         break;
        case 41: iSet = TRACK_BATTLE_CITYBOSS;      break;
        case 42: iSet = TRACK_BATTLE_FORESTBOSS;    break;
        case 43: iSet = TRACK_BATTLE_LIZARDBOSS;    break;
        case 44: iSet = TRACK_BATTLE_DRAGON;        break;
        case 45: iSet = TRACK_BATTLE_ARIBETH;       break;
        case 46: iSet = TRACK_BATTLE_ENDBOSS;       break;
        case 51: iSet = TRACK_CITYSLUMDAY;          break;
        case 52: iSet = TRACK_CITYSLUMNIGHT;        break;
        case 53: iSet = TRACK_CITYDOCKDAY;          break;
        case 54: iSet = TRACK_CITYDOCKNIGHT;        break;
        case 55: iSet = TRACK_CITYWEALTHY;          break;
        case 56: iSet = TRACK_CITYMARKET;           break;
        case 57: iSet = TRACK_CITYNIGHT;            break;
        case 58: iSet = TRACK_THEME_NWN;            break;
        case 61: iSet = TRACK_TAVERN1;              break;
        case 62: iSet = TRACK_TAVERN2;              break;
        case 63: iSet = TRACK_TAVERN3;              break;
        case 64: iSet = TRACK_TAVERN4;              break;
        case 65: iSet = TRACK_RICHHOUSE;            break;
        case 66: iSet = TRACK_STORE;                break;
        case 67: iSet = TRACK_TEMPLEGOOD;           break;
        case 68: iSet = TRACK_TEMPLEGOOD2;          break;
        case 69: iSet = TRACK_CASTLE;               break;
        case 71: iSet = TRACK_TEMPLEEVIL;           break;
        case 72: iSet = TRACK_DUNGEON1;             break;
        case 73: iSet = TRACK_SEWER;                break;
        case 74: iSet = TRACK_MINES1;               break;
        case 75: iSet = TRACK_MINES2;               break;
        case 76: iSet = TRACK_CRYPT1;               break;
        case 77: iSet = TRACK_CRYPT2;               break;
        case 78: iSet = TRACK_EVILDUNGEON1;         break;
        case 79: iSet = TRACK_EVILDUNGEON2;         break;
        case 81: iSet = TRACK_RURALDAY1;            break;
        case 82: iSet = TRACK_RURALDAY2;            break;
        case 83: iSet = TRACK_RURALNIGHT;           break;
        case 84: iSet = TRACK_FORESTDAY1;           break;
        case 85: iSet = TRACK_FORESTDAY2;           break;
        case 86: iSet = TRACK_FORESTNIGHT;          break;
        case 91: iSet = TRACK_THEME_CHAPTER1;       break;
        case 92: iSet = TRACK_THEME_CHAPTER2;       break;
        case 93: iSet = TRACK_THEME_CHAPTER3;       break;
        case 94: iSet = TRACK_THEME_CHAPTER4;       break;
        case 95: iSet = TRACK_THEME_ARIBETH1;       break;
        case 96: iSet = TRACK_THEME_ARIBETH2;       break;
        case 97: iSet = TRACK_THEME_GEND;           break;
        case 98: iSet = TRACK_THEME_MAUGRIM;        break;
        case 99: iSet = TRACK_THEME_MORAG;          break;
        default: 
            break;
    }
...
void DoEmoteFunction(int iEmote, object oUser)
{
    ...
    case 6: 
        AssignCommand(oTarget, PlayAnimation( ANIMATION_FIREFORGET_READ, 1.0)); 
        DelayCommand(3.0f, AssignCommand(oTarget, PlayAnimation( ANIMATION_FIREFORGET_READ, 1.0)));
        break;
    ...
    case 95: 
        AssignCommand(oTarget, ActionPlayAnimation( ANIMATION_LOOPING_SIT_CROSS, 1.0, fDur)); 
        DelayCommand(1.0f, AssignCommand(oTarget, PlayAnimation( ANIMATION_FIREFORGET_DRINK, 1.0))); 
        DelayCommand(3.0f, AssignCommand(oTarget, PlayAnimation( ANIMATION_LOOPING_SIT_CROSS, 1.0, fDur)));
        break;
    case 96: 
        AssignCommand(oTarget, ActionPlayAnimation( ANIMATION_LOOPING_SIT_CROSS, 1.0, fDur)); 
        DelayCommand(1.0f, AssignCommand(oTarget, PlayAnimation( ANIMATION_FIREFORGET_READ, 1.0))); 
        DelayCommand(3.0f, AssignCommand(oTarget, PlayAnimation( ANIMATION_LOOPING_SIT_CROSS, 1.0, fDur)));
        break;
