...
string csv_SetKeyValuePair(string sList, string sKey, string sValue)
{
    ...
    for (i = 0; i < nCount; i++)
    {
        ...
        if(StringParse(sCurrentPair, ":") == sKey)
            sUserSettings = RemoveListItem(sList, sCurrentPair);
            break;
    }
...
void csv_SetKeyValueString(string sList, string sKey, string sValue)
{
    csv_SetKeyValuePair(sList, sKey, sValue);
}
...
string csv_RemoveKeyValuePair(string sList, string sKey)
{
    ...
    for (i = 0; i < nCount; i++)
    {
        ...
        if(StringParse(sCurrentPair, ":") == sKey)
        {
            sList = RemoveListItem(sUserSettings, sCurrentSetting);
            break;
        }    
    }
...
string csv_GetKeyValuePair(string sList, string sKey)
{
    ...
    for (i = 0; i < nCount; i++)
    {
        sCurrentPair = GetListItem(sList, i);
        if(StringParse(sCurrentPair, ":") == sKey)
            return StringParse(sCurrentSetting, ":", TRUE);
    }
...
int csv_GetKeyValueInt(string sSetting, string sKey)
{
