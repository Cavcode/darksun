...
const string DMFI_DATA = "DMFI Data";
object DMFI = GetDatapoint(DMFI_DATA);
...
string DMFI_DEFAULT_DM_SETTINGS = "ALIGNMENT_SHIFT:5,BEAM_DURATION:5.0,BUFF_LEVEL:LOW,BUFF_PARTY:FALSE," +
    "DICEBAG:PRIVATE,EFFECT_DELAY:1.0,EFFECT_DURATION:60.0,EMOTES_MUTED:FALSE,REPUTATION:5.0,SAFE_FACTIONS:0," +
    "SAVE_AMOUNT:5.0,SOUND_DELAY:0.2,STUN_DURATION:1000.0,DICEBAG_ANIMATION:TRUE";
const string DMFI_DEFAULT_PC_SETTINGS = "EMOTES_MUTED:FALSE,DICEBAG_ANIMATION:TRUE,DICEBAG:PRIVATE";
...
const int DMFI_SORT_LIST = FALSE;
...
//Wand Variables
const string DMFI_WAND_DISPLAY_NAME = "DMFI_WAND_DISPLAY_NAME";
const string DMFI_WAND_ACTIVE = "DMFI_WAND_ACTIVE";
...
string DMFI_LANGUAGE_INSTALLED = "common,drow,abyssal,celestial,cant,infernal,draconic,goblin,dwarf,elven,"+
...
string DMFI_DM_WAND_INVENTORY = "afflict,dicebag,pc_dicebag,pc_follow,pc_emote,server,encounter,faction,emote,fx," +
                                      "music,sound,voice,xp,500xp,en_ditto,mute,peace,voiceWidget,remove,dmw,target," +
                                      "buff,dmbook,playerbook,jail_widget,naming";
const string DMFI_PC_WAND_INVENTORY = "playerbook,emote";
